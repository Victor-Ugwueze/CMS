...
<?php include("./includes/header.php"); ?>
			...
			<div id="staff-page">
				<h2 style="padding-left: 10px;">Edit Page: <?php echo $sel_pg['menu_name']; ?></h2><br /><br />
        ...
        <?php
         ...
         ?>
        <form method="post" action="edit_page.php?page= <?php echo urlencode($sel_pg['id']);  ?>">

          page name:
          <input type="text"  name="menu_name" value="<?php echo $sel_pg['menu_name']; ?>"><br /><br />
					<?php

            $query= "SELECT *FROM pages WHERE subject_id ={$sel_pg['subject_id']}";
            $result = mysql_query($query);
            confirm_query($result);
        ...
        <textarea  name="content"><?php echo $sel_pg['content']; ?></textarea>

        <input type="submit" value="Update" name="Edit_submit">
        &nbsp;
        &nbsp;
        <a href="add_new_page.php?page= <?php echo urlencode($sel_pg['id']); ?>">Add_page</a>
        <a href="delete_page.php?page= <?php echo urlencode($sel_pg['id']); ?>" onclick="return confirm('Are you sure you want to delete this');" >delete</a>
